...
public class SpUtils {
    ...
    private static SharedPreferences getSettingPreferences(Context context) {
        ...
        setting = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        return setting;
    }


    private String saveString(String string) {
        return string + "";
    }
